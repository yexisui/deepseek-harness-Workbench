 ...
 * verified against the 0.1.5-rc.1 cohort dist bundle). The 0.1.2 shell
 * removed the dsh-client-runtime row (package deleted upstream) and added
 * dsh-client-store as the replacement static module; the 0.1.5-rc.1 shell
 * added the dsh-client-ui-dockkit row.
 */
