...
// This component test exercises pairing behavior. The platform owns these
// static icons; importing its whole primitive bundle would also initialize
// unrelated Markdown/highlighting dependencies outside this plugin's scope.
...
describe('RemoteEntry', () => {
  ...
  it('shows the lan-required banner instead of a QR when the bind is loopback-only', async () => {
    ...
    await waitFor(() => expect(screen.getByText('This feature needs a LAN bind')).toBeTruthy())
