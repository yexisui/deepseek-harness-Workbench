 ...
 * sidebar-foot entry (phone trigger + pairing panel), and
...
export function apply(ctx: ClientContext): void {
  ...
  // Remote desktop channel: on a non-loopback origin (LAN address) the connection plugin's /api fence refuses this desktop Web GUI,
