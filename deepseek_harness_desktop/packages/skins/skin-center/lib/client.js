      ...
      `;
		...
		*/
		...
		const en = {
			...
			verifyFoundIssues: "Found {count} skin(s) with integrity issues. Import the affected skins again from a local ZIP or folder in Workshop.",
		...
		const zh = {
			...
			verifyFoundIssues: "发现 {count} 款皮肤存在完整性异常，请在创意工坊重新导入对应的本地 ZIP 或文件夹。",
