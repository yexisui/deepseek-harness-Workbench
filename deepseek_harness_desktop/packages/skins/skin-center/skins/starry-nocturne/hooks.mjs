/**
 * starry-nocturne skin hooks — ambient particles (x-org.linxin666.skin-center/v1alpha1).
...
export default function defineSkinHooks() {
  const LIGHT = {"color":"#B4BCF0","glow":"rgba(180,188,240,0.85)"}
  const DARK = {"color":"#C9CFF2","glow":"rgba(180,188,240,0.8)"}
  const STYLE = "stars"
  const COUNT = 16
