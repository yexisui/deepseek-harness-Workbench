/**
 * Blue Fantasy (blue-fantasy) skin hooks — the trusted escape hatch of the v2 skin
 ...
 *
 * Port of the v1 plugin effects (packages/skins/blue-fantasy/src/client/index.ts):
