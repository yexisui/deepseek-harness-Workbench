...
export interface DoctorPolicy {
  ...
  autoRepair: boolean
  /** Compatibility field; author aggregate migration is disabled. */
  autoMigrate: boolean
}

export const DEFAULT_DOCTOR_POLICY: DoctorPolicy = { fullProtection: true, autoRepair: false, autoMigrate: false }
