...
| `composer` | plain-chat | 未选工作区时的初始对话输入区；`[data-dsh-plugin="plain-chat"][data-dsh-part="composer"]` |
...
| `plain-chat` | dsh-client-ui-plain-chat | 无工作区普通聊天输入区；`[data-dsh-plugin="plain-chat"]` |
