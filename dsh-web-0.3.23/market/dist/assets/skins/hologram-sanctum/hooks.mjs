/**
 * hologram-sanctum skin hooks — ambient particles (x-org.linxin666.skin-center/v1alpha1).
...
export default function defineSkinHooks() {
  const LIGHT = {"color":"#5BD8EA","glow":"rgba(94,226,240,0.7)"}
  const DARK = {"color":"#7EE7F2","glow":"rgba(94,226,240,0.85)"}
  const STYLE = "motes"
  const COUNT = 14
