...
<tr><td>GET</td><td><code>/api/stats</code></td><td>每类（skin / pet / plugin / preset）每个资产的投票数与安装数；边缘缓存 1 分钟，D1 故障时回退最近一次成功计数</td><td>200 / 503</td></tr>
<tr><td>POST</td><td><code>/api/like</code></td><td>点赞 / 取消点赞（每设备一票，Turnstile 校验；资产须为已发布 manifest 成员，正文上限 4 KiB），字段：<code>kind</code>、<code>asset_id</code>、<code>device_fp</code>、<code>turnstile_token</code>、<code>unlike</code></td><td>200 / 400 / 403 / 413</td></tr>
    <tr><td>POST</td><td><code>/api/install</code></td><td>记录一次成功的创意工坊安装（皮肤 / 宠物 / 插件 / 预设），Turnstile 校验；字段：<code>kind</code>、<code>asset_id</code>、<code>device_fp</code>、<code>install_id</code>、<code>turnstile_token</code>（资产须为已发布 manifest 成员，正文上限 4 KiB）</td><td>200 / 400 / 403 / 413</td></tr>
...
<tr><td>GET</td><td><code>/api/npm-badge/total</code></td><td>Shields 端点徽章：全部已发布家族包（含新旧聚合包名与已退役包名）的全渠道累计下载量合计：npm 官方源 + npmmirror 镜像源 + GitHub Releases 附件</td><td>200</td></tr>
